...
правды по UX-скриптам и протоколам безопасности. Логика обновления нагрузок описана в отдельном документе [«Внутренний движок ассистента»](vnutrenniy-assistent-dvizhok.md).
